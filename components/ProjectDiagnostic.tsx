                        ...
                        <div className="p-4 border-t border-gray-800 flex-shrink-0">
                            <form onSubmit={handleChatSubmit} className="flex gap-4">
                                ...
                                <input
                                    ...
                                    disabled={isLoading}
                                    className="flex-grow bg-transparent text-white focus:outline-none focus:ring-2 focus:ring-yellow-300/50 rounded"
                                    autoFocus
                                />
                                <button type="submit" disabled={isLoading || !input.trim()} className="text-yellow-300 uppercase tracking-widest hover:text-white disabled:text-gray-700 transition-colors active:scale-95">
                                    {t('contato.form.send')}
                                </button>
                            </form>
                        </div>
