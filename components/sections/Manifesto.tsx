...
const Manifesto: React.FC = () => {
    ...
    // Easter Egg State
    const [symphonyClicks, setSymphonyClicks] = useState(0);
    const [showSymphonyEgg, setShowSymphonyEgg] = useState(false);
    const symphonyClickTimer = useRef<ReturnType<typeof setTimeout> | null>(null);
    const [showMottoSecret, setShowMottoSecret] = useState(false);
