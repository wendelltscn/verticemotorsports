            ...
            <div className="relative z-10 p-6 flex flex-col items-center max-w-4xl mx-auto">
                ...
                <div className="space-y-6 text-lg text-gray-300 leading-relaxed">
                    <p>
                     ...
                     <p>
                        É sobre o nascer do sol em uma serra deserta, o som de motores ecoando em um vale, a camaradagem forjada em quilômetros. VERTICE Run é a prova de que a paixão automotiva é uma experiência coletiva, uma celebração do{' '}
                        <a 
