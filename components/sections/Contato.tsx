...
const Contato: React.FC = () => {
    ...
    const [showCopyrightSecret, setShowCopyrightSecret] = useState(false);
    const [mottoClicks, setMottoClicks] = useState(0);
    const [showMottoSecret, setShowMottoSecret] = useState(false);
    const [phoneClicks, setPhoneClicks] = useState(0);
    const [showPhoneSecret, setShowPhoneSecret] = useState(false);
