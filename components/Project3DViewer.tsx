...
// FIX: Replaced the inline type declaration with an explicit interface (`ModelViewerProps`)
// to correctly extend JSX.IntrinsicElements for the 'model-viewer' custom element.
// This resolves the TypeScript error where the component was not recognized.
