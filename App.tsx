...
const App: React.FC = () => {
    ...
    const allBackgroundImages = [
        ...
        'https://i.imgur.com/4bzpSbj.png', // Background for Conceito
        'https://i.imgur.com/NWGRjXa.png' // Background for Podcast & Lifestyle
    ];
    ...
    // Blueprint Mode (Konami Code)
     useEffect(() => {
        ...
        const handleKeyDown = (e: KeyboardEvent) => {
            if (isTerminalMode) return; // Don't trigger while terminal is open
